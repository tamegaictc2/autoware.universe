  ...
  const double b, const double a, const rclcpp::Time & now, const size_t idx)
{
  auto marker = autoware_universe_utils::createDefaultMarker(
    ...
    autoware_universe_utils::createMarkerScale(width, 0.0, 0.0),
    autoware_universe_utils::createMarkerColor(r, g, b, a));
  ...
  const double r, const double g, const double b, const double a, const rclcpp::Time & now)
{
  auto marker = tier4_autoware_utils::createDefaultMarker(
    "map", now, ns, 1, Marker::LINE_STRIP, tier4_autoware_utils::createMarkerScale(width, 0.0, 0.0),
    tier4_autoware_utils::createMarkerColor(r, g, b, a));
  marker.lifetime = rclcpp::Duration(0, 0);
